...
for video_file in video_files:
    frame_extract_folder = 'Extracts'
    superRes_extract_folder = 'Improved'
    output_folder = 'Images'
    frame_extract_folder += '_' + video_file
    superRes_extract_folder += '_' + video_file
    output_folder += '_' + video_file
